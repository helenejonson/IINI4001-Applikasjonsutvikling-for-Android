...
class HttpWrapperThreaded {
	...
	public HttpWrapperThreaded(GameActivity activity, String urlToServer){
		this.activity = activity;
		this.urlToServer = urlToServer;
		CookieHandler.setDefault(new CookieManager(null, CookiePolicy.ACCEPT_ALL));
	}

	public void runHttpRequestInThread(HttpRequestType typeOfRequest, Map<String, String> requestValues){
